...
- [php/run.php](/home/disarli/Downloads/omniq-core/validation/scenario-17-grouped-ack-fail/php/run.php)
...
```bash
docker compose exec omniq-php sh -lc 'cd /workspace/omniq-php && QUEUE=validation-s17-php php /workspace/omniq/validation/scenario-17-grouped-ack-fail/php/run.php'
```
