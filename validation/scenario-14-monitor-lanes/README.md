...
- [php/run.php](/home/disarli/Downloads/omniq-core/validation/scenario-14-monitor-lanes/php/run.php)
...
```bash
docker compose exec omniq-php sh -lc 'cd /workspace/omniq-php && QUEUE=validation-s14-php php /workspace/omniq/validation/scenario-14-monitor-lanes/php/run.php'
```
