...
- [php/run.php](/home/disarli/Downloads/omniq-core/validation/scenario-20-batch-retry-errors/php/run.php)
...
```bash
docker compose exec omniq-php sh -lc 'cd /workspace/omniq-php && QUEUE=validation-s20-php php /workspace/omniq/validation/scenario-20-batch-retry-errors/php/run.php'
```
