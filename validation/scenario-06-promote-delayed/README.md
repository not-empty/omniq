...
- [php/run.php](/Users/disarli/Documents/ops/omniq/validation/scenario-06-promote-delayed/php/run.php)
...
```bash
docker compose exec omniq-php sh -lc 'cd /workspace/omniq-php && QUEUE=validation-s06-php php /workspace/omniq/validation/scenario-06-promote-delayed/php/run.php'
```
